...
export default function SliderKPR () {
      ...
      >
        {
          imagesSlider.map((images,i)=>
            ...
            <View
              ...
              style={{width}}
            >
              <Image style={{resizeMode:'contain',width}} source={require('../../assets/kprasset.png')}/>
            </View>
          )
        }
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  pagination:{flexDirection:'row',position:'absolute',alignSelf:'center',top:25}
});
